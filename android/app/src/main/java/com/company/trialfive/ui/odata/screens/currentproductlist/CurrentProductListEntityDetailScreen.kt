package com.company.trialfive.ui.odata.screens.currentproductlist
...
import com.sap.cloud.android.odata.northwindentities.CurrentProductList

val CurrentProductListEntityDetailScreen: @Composable (
                ...
                Column(
                    ...
                    FioriKeyValueCell(
                        content = FioriKeyValueCellContent(
                                key = CurrentProductList.productID.name,
                                value = entity.getOptionalValue(CurrentProductList.productID)?.toString() ?: ""
                            )
                        )
                    FioriKeyValueCell(
                        content = FioriKeyValueCellContent(
                                key = CurrentProductList.productName.name,
                                value = entity.getOptionalValue(CurrentProductList.productName)?.toString() ?: ""
                            )
                        )
                }
            }

package com.company.trialfive.ui.odata.viewmodel.orderdetailsextended
...
class OrderDetailsExtendedODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.orderDetailsExtended,
    NorthwindEntitiesMetadata.EntitySets.orderDetailsExtendeds,
    orderByProperty,
    parent,

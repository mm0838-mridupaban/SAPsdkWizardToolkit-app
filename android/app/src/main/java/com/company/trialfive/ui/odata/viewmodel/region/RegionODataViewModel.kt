package com.company.trialfive.ui.odata.viewmodel.region
...
class RegionODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.region,
    NorthwindEntitiesMetadata.EntitySets.regions,
    orderByProperty,
    parent,

package com.company.trialfive.ui.odata.viewmodel.shipper
...
class ShipperODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.shipper,
    NorthwindEntitiesMetadata.EntitySets.shippers,
    orderByProperty,
    parent,

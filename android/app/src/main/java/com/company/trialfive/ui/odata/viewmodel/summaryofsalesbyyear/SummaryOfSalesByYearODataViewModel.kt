package com.company.trialfive.ui.odata.viewmodel.summaryofsalesbyyear
...
class SummaryOfSalesByYearODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.summaryOfSalesByYear,
    NorthwindEntitiesMetadata.EntitySets.summaryOfSalesByYears,
    orderByProperty,
    parent,

package com.company.trialfive.ui.odata.viewmodel.salestotalsbyamount
...
class SalesTotalsByAmountODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.salesTotalsByAmount,
    NorthwindEntitiesMetadata.EntitySets.salesTotalsByAmounts,
    orderByProperty,
    parent,

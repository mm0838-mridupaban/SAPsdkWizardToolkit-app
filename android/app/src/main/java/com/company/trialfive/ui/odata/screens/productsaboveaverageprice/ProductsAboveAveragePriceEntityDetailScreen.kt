...
import com.sap.cloud.android.odata.northwindentities.ProductsAboveAveragePrice

val ProductsAboveAveragePriceEntityDetailScreen: @Composable (
                ...
                Column(
                    ...
                    FioriKeyValueCell(
                        content = FioriKeyValueCellContent(
                                key = ProductsAboveAveragePrice.productName.name,
                                value = entity.getOptionalValue(ProductsAboveAveragePrice.productName)?.toString() ?: ""
                            )
                        )
                    FioriKeyValueCell(
                        content = FioriKeyValueCellContent(
                                key = ProductsAboveAveragePrice.unitPrice.name,
                                value = entity.getOptionalValue(ProductsAboveAveragePrice.unitPrice)?.toString() ?: ""
                            )
                        )
                }
            }

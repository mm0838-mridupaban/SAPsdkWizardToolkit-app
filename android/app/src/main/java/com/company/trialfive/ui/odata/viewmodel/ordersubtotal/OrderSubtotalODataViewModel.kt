package com.company.trialfive.ui.odata.viewmodel.ordersubtotal
...
class OrderSubtotalODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.orderSubtotal,
    NorthwindEntitiesMetadata.EntitySets.orderSubtotals,
    orderByProperty,
    parent,

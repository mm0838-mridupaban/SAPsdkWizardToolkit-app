package com.company.trialfive.ui.odata.viewmodel.order
...
class OrderODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.order,
    NorthwindEntitiesMetadata.EntitySets.orders,
    orderByProperty,
    parent,

package com.company.trialfive.ui.odata.screens.productsalesfor1997
...
import com.sap.cloud.android.odata.northwindentities.ProductSalesFor1997

val ProductSalesFor1997EntityDetailScreen: @Composable (
                ...
                Column(
                    ...
                    FioriKeyValueCell(
                        content = FioriKeyValueCellContent(
                                key = ProductSalesFor1997.categoryName.name,
                                value = entity.getOptionalValue(ProductSalesFor1997.categoryName)?.toString() ?: ""
                            )
                        )
                    FioriKeyValueCell(
                        content = FioriKeyValueCellContent(
                                key = ProductSalesFor1997.productName.name,
                                value = entity.getOptionalValue(ProductSalesFor1997.productName)?.toString() ?: ""
                            )
                        )
                    FioriKeyValueCell(
                        content = FioriKeyValueCellContent(
                                key = ProductSalesFor1997.productSales.name,
                                value = entity.getOptionalValue(ProductSalesFor1997.productSales)?.toString() ?: ""
                            )
                        )
                }
            }

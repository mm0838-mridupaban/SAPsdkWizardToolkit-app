package com.company.trialfive.ui.odata.viewmodel.category
...
class CategoryODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.category,
    NorthwindEntitiesMetadata.EntitySets.categories,
    orderByProperty,
    parent,

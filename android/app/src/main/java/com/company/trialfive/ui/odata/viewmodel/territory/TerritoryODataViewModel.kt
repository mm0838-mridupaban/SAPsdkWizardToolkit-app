package com.company.trialfive.ui.odata.viewmodel.territory
...
class TerritoryODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.territory,
    NorthwindEntitiesMetadata.EntitySets.territories,
    orderByProperty,
    parent,

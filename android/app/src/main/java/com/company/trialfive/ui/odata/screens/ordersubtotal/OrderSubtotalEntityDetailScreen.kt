package com.company.trialfive.ui.odata.screens.ordersubtotal
...
import com.sap.cloud.android.odata.northwindentities.OrderSubtotal

val OrderSubtotalEntityDetailScreen: @Composable (
                ...
                Column(
                    ...
                    FioriKeyValueCell(
                        content = FioriKeyValueCellContent(
                                key = OrderSubtotal.orderID.name,
                                value = entity.getOptionalValue(OrderSubtotal.orderID)?.toString() ?: ""
                            )
                        )
                    FioriKeyValueCell(
                        content = FioriKeyValueCellContent(
                                key = OrderSubtotal.subtotal.name,
                                value = entity.getOptionalValue(OrderSubtotal.subtotal)?.toString() ?: ""
                            )
                        )
                }
            }

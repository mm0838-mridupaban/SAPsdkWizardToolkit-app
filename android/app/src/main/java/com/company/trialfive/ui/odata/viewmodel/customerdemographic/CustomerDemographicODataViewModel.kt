package com.company.trialfive.ui.odata.viewmodel.customerdemographic
...
class CustomerDemographicODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.customerDemographic,
    NorthwindEntitiesMetadata.EntitySets.customerDemographics,
    orderByProperty,
    parent,

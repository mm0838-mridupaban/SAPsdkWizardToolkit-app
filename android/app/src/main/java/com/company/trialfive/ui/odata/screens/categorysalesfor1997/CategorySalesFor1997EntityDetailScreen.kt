package com.company.trialfive.ui.odata.screens.categorysalesfor1997
...
import com.sap.cloud.android.odata.northwindentities.CategorySalesFor1997

val CategorySalesFor1997EntityDetailScreen: @Composable (
                ...
                Column(
                    ...
                    FioriKeyValueCell(
                        content = FioriKeyValueCellContent(
                                key = CategorySalesFor1997.categoryName.name,
                                value = entity.getOptionalValue(CategorySalesFor1997.categoryName)?.toString() ?: ""
                            )
                        )
                    FioriKeyValueCell(
                        content = FioriKeyValueCellContent(
                                key = CategorySalesFor1997.categorySales.name,
                                value = entity.getOptionalValue(CategorySalesFor1997.categorySales)?.toString() ?: ""
                            )
                        )
                }
            }

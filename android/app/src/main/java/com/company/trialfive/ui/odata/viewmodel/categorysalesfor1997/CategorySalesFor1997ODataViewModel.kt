package com.company.trialfive.ui.odata.viewmodel.categorysalesfor1997
...
class CategorySalesFor1997ODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.categorySalesFor1997,
    NorthwindEntitiesMetadata.EntitySets.categorySalesFor1997,
    orderByProperty,
    parent,

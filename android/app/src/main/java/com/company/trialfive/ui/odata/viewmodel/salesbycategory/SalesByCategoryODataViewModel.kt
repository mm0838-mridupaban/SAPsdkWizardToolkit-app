package com.company.trialfive.ui.odata.viewmodel.salesbycategory
...
class SalesByCategoryODataViewModel(
    ...
    application,
    NorthwindEntitiesMetadata.EntityTypes.salesByCategory,
    NorthwindEntitiesMetadata.EntitySets.salesByCategories,
    orderByProperty,
    parent,
